...
// Library implementation of Dialog with minWidth reset
...
class CustomDialog extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return AnimatedPadding(
      key: Key('custom_lib_dialog_animated_padding'),
      ...
      child: MediaQuery.removeViewInsets(
        ...
        context: context,
        child: Center(
          key: Key('custom_lib_dialog_center'),
          child: ConstrainedBox(
            key: Key('custom_lib_dialog_constrained_box'),
            constraints: const BoxConstraints(minWidth: 70.0),
            child: Material(
              key: Key('custom_lib_dialog_material'),
